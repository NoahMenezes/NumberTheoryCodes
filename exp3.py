...
def plot_extended_gcd_table(orig_a, orig_b, gcd, extended_rows):
    ...
    ax.set_title(f"Extended Euclid Algorithm Table | GCD({orig_a}, {orig_b}) = {gcd}", pad=20,
...
def lde(a, b, c):
    print(f"\nEquation: {a}x + {b}y = {c}\n")
    d, s_orig, t_orig, table_rows = extended_gcd(a, b)
    print(f"d = gcd({a}, {b}) = {d}")
    ...
    gcd_1, s, t, _ = extended_gcd(a1, b1)
